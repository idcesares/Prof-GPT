import { o as De, t as ye } from "../chunks/index.c8c01468.js";
import {
  S as He,
  a as Je,
  I as V,
  ...
  P as qe,
  h as We,
} from "../chunks/singletons.93acf30e.js";
function Xe(t, o) {
  return t === "/" || o === "ignore"
    ? t
    : o === "never"
...
window.fetch = (t, o) => (
  (t instanceof Request
    ? t.method
    : (o == null ? void 0 : o.method) || "GET") !== "GET" && te.delete(Se(t)),
  fe(t, o)
);
const te = new Map();
function it(t, o) {
  ...
  if (i != null && i.textContent) {
    const { body: d, ...f } = JSON.parse(i.textContent),
      S = i.getAttribute("data-ttl");
    return (
      S && te.set(u, { body: d, init: f, ttl: 1e3 * Number(S) }),
...
function dt(t, o, u) {
  ...
  for (let S = 0; S < o.length; S += 1) {
    ...
    if (!l.matcher || u[l.matcher](b)) {
      ...
      const w = o[S + 1],
        p = d[S + 1];
      w && !w.rest && w.optional && p && l.chained && (f = 0);
      continue;
    }
...
function pt({ nodes: t, server_loads: o, dictionary: u, matchers: i }) {
  const d = new Set(o);
  return Object.entries(u).map(([l, [b, w, p]]) => {
    const { pattern: D, params: x } = lt(l),
      k = {
        id: l,
        exec: (N) => {
          const P = D.exec(N);
...
async function ht(t) {
  var o;
  for (const u in t)
    if (typeof ((o = t[u]) == null ? void 0 : o.then) == "function")
      return Object.fromEntries(
        await Promise.all(Object.entries(t).map(async ([i, d]) => [i, await d]))
      );
  return t;
}
const gt = -1,
...
function Rt(t, o) {
  ...
  const f = document.documentElement,
    ...
    l = [];
  let b = null;
  const w = { before_navigate: [], after_navigate: [] };
  let p = { branch: [], error: null, url: null },
    ...
    B = !1,
    q,
    j = ($e = history.state) == null ? void 0 : $e[V];
  j ||
    ((j = Date.now()),
    history.replaceState({ ...history.state, [V]: j }, "", location.href));
  const ue = K[j];
  ...
  function Re(e) {
    l.some((n) => (n == null ? void 0 : n.snapshot)) &&
      (Z[e] = l.map((n) => {
        var r;
        return (r = n == null ? void 0 : n.snapshot) == null
          ? void 0
          : r.capture();
      }));
  }
  ...
  async function Le(e) {
    return (
      (b = {
        id: e.id,
        promise: he(e).then(
          (n) => (n.type === "loaded" && n.state.error && (b = null), n)
        ),
      }),
      b.promise
    );
  ...
  async function oe(...e) {
    const r = u
      .filter((a) => e.some((s) => a.exec(s)))
      .map((a) =>
        Promise.all(
          [...a.layouts, a.leaf].map((s) => (s == null ? void 0 : s[1]()))
        )
      );
    await Promise.all(r);
  }
  function Oe(e) {
    ...
    n && n.remove(),
      ...
      (q = new t.root({
        target: o,
        props: { ...e.props, stores: M, components: l },
        hydrate: !0,
      })),
      Ae(j);
    const r = {
      ...
      to: {
        params: p.params,
        route: { id: ((a = p.route) == null ? void 0 : a.id) ?? null },
  ...
  async function Y({
    ...
    let m = "never";
    for (const _ of r)
      (_ == null ? void 0 : _.slash) !== void 0 && (m = _.slash);
    (e.pathname = Xe(e.pathname, m)), (e.search = e.search);
    const v = {
      type: "loaded",
      state: { url: e, params: n, branch: r, error: s, route: c },
      props: { constructors: St(r).map((_) => _.node.component) },
    };
    ...
    for (let _ = 0; _ < Math.max(r.length, p.branch.length); _ += 1) {
      const h = r[_],
        U = p.branch[_];
      (h == null ? void 0 : h.data) !== (U == null ? void 0 : U.data) &&
        (R = !0),
        h &&
          ((y = { ...y, ...h.data }),
          R && (v.props[`data_${A}`] = y),
  ...
  async function de({
    ...
    if ((y = v.universal) != null && y.load) {
      ...
      const _ = {
        ...
        params: new Proxy(a, { get: (h, U) => (m.params.add(U), h[U]) }),
        ...
        async fetch(h, U) {
          ...
          return (
            O(C.href),
            C.origin === r.origin && ($ = C.href.slice(r.origin.length)),
            x ? st($, C.href, U) : it($, U)
          );
        },
        setHeaders: () => {},
      ...
      (g = (await v.universal.load.call(null, _)) ?? null),
        (g = g ? await ht(g) : null);
    }
    return {
      node: v,
      ...
      server: c,
      universal:
        (R = v.universal) != null && R.load
          ? { type: "data", data: g, uses: m }
          : null,
      data: g ?? (c == null ? void 0 : c.data) ?? null,
      slash:
        ((A = v.universal) == null ? void 0 : A.trailingSlash) ??
  ...
  async function he({ id: e, invalidating: n, url: r, params: a, route: s }) {
    ...
    const { errors: c, layouts: g, leaf: m } = s,
      v = [...g, m];
    c.forEach((E) => (E == null ? void 0 : E().catch(() => {}))),
    ...
    const _ = v.map((E, L) => {
      ...
      const I = p.branch[L],
        T =
          !!(E != null && E[0]) &&
          ((I == null ? void 0 : I.loader) !== E[1] ||
            Pe(O, A, R, (H = I.server) == null ? void 0 : H.uses, a));
      return T && (O = !0), T;
    });
    if (_.some(Boolean)) {
      try {
        ...
        return ie({
          ...
          error: await X(E, { url: r, params: a, route: { id: s.id } }),
          url: r,
          route: s,
        });
      }
    ...
    const $ = v.map(async (E, L) => {
      ...
      if (
        (!T || T.type === "skip") &&
        E[1] === (I == null ? void 0 : I.loader) &&
        !Pe(U, A, R, (ge = I.universal) == null ? void 0 : ge.uses, a)
      )
        return I;
      ...
      return de({
        ...
        parent: async () => {
          var Te;
          const je = {};
          for (let me = 0; me < L; me += 1)
            Object.assign(je, (Te = await $[me]) == null ? void 0 : Te.data);
          return je;
        },
        server_data_node: pe(
          T === void 0 && E[0] ? { type: "skip" } : T ?? null,
          E[0] ? (I == null ? void 0 : I.server) : void 0
        ),
      });
    });
    ...
    for (let E = 0; E < v.length; E += 1)
      if (v[E])
        try {
          ...
          else if (L instanceof ee) (I = L.status), (T = L.body);
          else {
            if (await M.updated.check()) return await G(r);
            T = await X(L, { params: a, url: r, route: { id: s.id } });
          }
  ...
  async function ie({ status: e, error: n, url: r, route: a }) {
    const s = {};
    let c = null;
  ...
  function xe({ url: e, type: n, intent: r, delta: a }) {
    var m, v;
    let s = !1;
    const c = {
      from: {
        params: p.params,
        route: { id: ((m = p.route) == null ? void 0 : m.id) ?? null },
        url: p.url,
      },
      to: {
        ...
        route: {
          id:
            ((v = r == null ? void 0 : r.route) == null ? void 0 : v.id) ??
            null,
        },
        url: e,
      },
  ...
  async function ce({
    ...
    var $, C, E;
    const R = W(e, !1),
      A = xe({ url: e, type: c, delta: g, intent: R });
    if (!A) {
      y();
      return;
    }
    const O = j;
    v(), (P = !0), x && M.navigating.set(A), (ne = m);
    let _ = R && (await he(R));
    if (!_) {
    ...
    if (_.type === "redirect")
      if (a.length > 10 || a.includes(e.pathname))
        ...
        return re(new URL(_.location, e).href, {}, [...a, e.pathname], m), !1;
    else
      (($ = _.props.page) == null ? void 0 : $.status) >= 400 &&
    ...
    if (
      ...
      (C = _.props.page) != null &&
        C.url &&
        _.props.page.url.pathname !== e.pathname &&
        (e.pathname = (E = _.props.page) == null ? void 0 : E.url.pathname),
      s)
    ) {
      const L = s.replaceState ? 0 : 1;
      if (
        ((s.state[V] = j += L),
        history[s.replaceState ? "replaceState" : "pushState"](s.state, "", e),
        !s.replaceState)
      ) {
        let I = j + 1;
        for (; Z[I] || K[I]; ) delete Z[I], delete K[I], (I += 1);
      }
    }
    (b = null),
      x
        ? ((p = _.state),
          _.props.page && (_.props.page.url = e),
          q.$set(_.props))
        : Oe(_);
    ...
    const U =
      document.activeElement !== h && document.activeElement !== document.body;
    !r && !U && Ee(),
      (k = !0),
      _.props.page && (F = _.props.page),
      (P = !1),
      c === "popstate" && Ae(j),
      w.after_navigate.forEach((L) => L(A)),
      M.navigating.set(null),
      (N = !1);
  }
  async function Ne(e, n, r, a) {
    return e.origin === location.origin &&
      ...
      !D
      ? await ie({ status: a, error: r, url: e, route: n })
      : await G(e);
  }
  function G(e) {
  ...
  function Ye() {
    ...
    f.addEventListener("mousedown", n),
      f.addEventListener("touchstart", n, { passive: !0 });
    const r = new IntersectionObserver(
      (c) => {
        for (const g of c)
          g.isIntersecting &&
            (oe(se(new URL(g.target.href))), r.unobserve(g.target));
      },
      { threshold: 0 }
    );
    function a(c, g) {
      const m = Ve(c, f);
      if (!m) return;
      const { url: v, external: y, download: R } = we(m, J);
      if (y || R) return;
      const A = le(m);
      if (!A.reload)
        if (g <= A.preload_data) {
    ...
    function s() {
      ...
      for (const c of f.querySelectorAll("a")) {
        const { url: g, external: m, download: v } = we(c, J);
        if (m || v) continue;
        const y = le(c);
        y.reload ||
          (y.preload_code === qe.viewport && r.observe(c),
          y.preload_code === qe.eager && oe(se(g)));
      }
    }
  ...
  return {
    ...
    preload_data: async (e) => {
      ...
      if (!r)
        throw new Error(
          `Attempted to preload a URL that does not belong to this app: ${n}`
        );
      await Le(r);
    },
    preload_code: oe,
    apply_action: async (e) => {
      if (e.type === "error") {
        ...
        e.type === "redirect"
          ...
          : (q.$set({
              form: null,
              page: { ...F, form: e.data, status: e.status },
            }),
            await ye(),
            q.$set({ form: e.data }),
            e.type === "success" && Ee());
    ...
    _start_router: () => {
      ...
      (history.scrollRestoration = "manual"),
        ...
        ((e = navigator.connection) != null && e.saveData) || Ye(),
        f.addEventListener("click", (n) => {
          ...
          if (!r) return;
          const { url: a, external: s, target: c, download: g } = we(r, J);
          if (!a) return;
          if (c === "_parent" || c === "_top") {
          ...
          if (
            ...
            return;
          if (s || m.reload) {
            xe({ url: a, type: "link" }) ? (P = !0) : n.preventDefault();
            return;
          }
        ...
        f.addEventListener("submit", (n) => {
          ...
          if (_e(c, J)) return;
          const g = n.target,
            { keep_focus: m, noscroll: v, reload: y, replace_state: R } = le(g);
          if (y) return;
          n.preventDefault(), n.stopPropagation();
          const A = new FormData(g),
            O = a == null ? void 0 : a.getAttribute("name");
          O &&
            A.append(O, (a == null ? void 0 : a.getAttribute("value")) ?? ""),
            (c.search = new URLSearchParams(A).toString()),
            ce({
              url: c,
              scroll: v ? Q() : null,
              keepfocus: m ?? !1,
        ...
        addEventListener("popstate", async (n) => {
          ...
          if ((r = n.state) != null && r[V]) {
            ...
            if (p.url.href.split("#")[0] === location.href.split("#")[0]) {
              (K[j] = Q()), (j = n.state[V]), scrollTo(a.x, a.y);
              return;
            }
            const s = n.state[V] - j;
            await ce({
    ...
    _hydrate: async ({
      ...
      ({ params: a = {}, route: s = { id: null } } = W(m, !1) || {});
      let v;
      try {
        const y = r.map(async (O, _) => {
            const h = c[_];
            return (
              h != null && h.uses && (h.uses = Ge(h.uses)),
              de({
                loader: t.nodes[O],
                url: m,
                params: a,
        ...
        v = await ie({
          ...
          error: await X(y, { url: m, params: a, route: s }),
          url: m,
          route: s,
        });
      }
...
async function Be(t, o) {
  const u = new URL(t);
  (u.pathname = rt(t.pathname)),
    u.searchParams.append(kt, o.map((d) => (d ? "1" : "0")).join(""));
  ...
  return new Promise(async (d) => {
    ...
    function b(D) {
      return vt(D, {
        Promise: (x) =>
          new Promise((k, N) => {
            f.set(x, { fulfil: k, reject: N });
          }),
      });
    }
    let w = "";
    for (;;) {
      const { done: D, value: x } = await S.read();
      if (D && !w) break;
      for (
        w +=
          !x && w
...
`);
        ...
        if (N.type === "data")
          ...
          const { id: P, data: z, error: B } = N,
            q = f.get(P);
          f.delete(P), B ? q.reject(b(B)) : q.fulfil(b(z));
        }
      }
    }
  });
        ...
        if (i.rangeCount === d.length) {
          for (let f = 0; f < i.rangeCount; f += 1) {
            const S = d[f],
              l = i.getRangeAt(f);
            if (
              S.commonAncestorContainer !== l.commonAncestorContainer ||
              S.startContainer !== l.startContainer ||
              S.endContainer !== l.endContainer ||
...
async function Lt(t, o, u) {
  const i = Rt(t, o);
  We({ client: i }),
    u ? await i._hydrate(u) : i.goto(location.href, { replaceState: !0 }),
    i._start_router();
}
export { Lt as start };
