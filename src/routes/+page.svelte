...
<div class="container">
  ...
  <div class="form-container">
    <form>
      ...
      <div class="mb-3">
        <label for="nivelEducacao" class="form-label">Nível de Educação</label>
        <select class="form-control" id="nivelEducacao" bind:value="{nivelEducacao}">
